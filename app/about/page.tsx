        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-section fv-body-bold font-bold text-black mb-6">
              Nearly three decades serving New Mexico.
            </h2>
      ...
      <section className="section-border py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-body-lg fv-body text-secondary mb-12">
            Real people. Real experience. No call centers.
          </p>

          <div className="space-y-px bg-border rounded-2xl overflow-hidden">
            {team.map(({ name, title, bio }) => (
              <div key={name} className="bg-white p-8 md:p-10 grid md:grid-cols-3 gap-8">
                <div>
                  <h3 className="text-card-h fv-body-semi font-semibold text-black">
                    {name}
                  </h3>
                  <p className="text-nav fv-nav text-secondary mt-1">{title}</p>
                </div>
                <div className="md:col-span-2 space-y-4">
                  {bio.map((paragraph, i) => (
                    <p key={i} className="text-body fv-body text-secondary leading-snug">
                      {paragraph}
                    </p>
                  ))}
                </div>
